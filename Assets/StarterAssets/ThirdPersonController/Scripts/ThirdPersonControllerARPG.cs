...
namespace StarterAssets
{
    ...
    public class ThirdPersonControllerARPG : MonoBehaviour
    {
        ...
        [Space]
        [Header("ATRIBUTOS CUSTOM DE LA CLASE")]
        ...
        public bool estaEnGuardia
        {
            ...
            set
            {
                if (value != _estaEnGuardia)
                {
                    ...
                    if (_estaEnGuardia == true)
                        eventoEnGuardia.Invoke();
                }
            }
        }

        public bool estaAtacando;
        public float layerAtacando = 0f;
        ...
        [Tooltip("Tamaño del jugador cuando está de pie")]
        ...
        private void MoveARPG()
        {
            ...
            if (_hasAnimator)
            {
                _animator.SetFloat("adelante", _input.move.y);
                _animator.SetFloat("derecha", _input.move.x);
            }
        }
        ...
        private void JumpAndGravity()
        {
            ...
            else if(estaAgachado == false && estaEnGuardia == false)
            {
